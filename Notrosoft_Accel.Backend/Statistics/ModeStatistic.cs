...
namespace Notrosoft_Accel.Backend.Statistics
{
    ...
    public class ModeStatistic : IStatistic
    {
            ...
            params object[] parameters)
        {
            ...
            var mode = flattenedArray.Aggregate((prev, curr) => prev.Value.Count() > curr.Value.Count() ? prev : curr).Key;
            ...
            params object[] parameters)
        {
            ...
            var mode = flattenedData.Aggregate((prev, curr) => prev.Value > curr.Value ? prev : curr).Key;
