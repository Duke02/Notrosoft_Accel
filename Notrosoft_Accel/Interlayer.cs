...
namespace Notrosoft_Accel
{
    internal class Interlayer
    {
        ...
        public string doStatistics(List<List<string>> input, StatisticType[] stats,
            Dictionary<string, IEnumerable<double>> intervals, params object[] param)
        {
            _doubles.Clear();
            _strings.Clear();
            ...
            foreach (var stat in stats)
            {
                switch (stat)
                {
                    case StatisticType.Mean:
                        ...
                        keyValues = mean.PerformStatistic((IEnumerable<OrdinalData>) ordData, null);
                    ...
                    case StatisticType.Median:
                        ...
                        keyValues = median.PerformStatistic((IEnumerable<OrdinalData>) ordData, null);
                    ...
                    case StatisticType.Mode:
                        ...
                        keyValues = mode.PerformStatistic((IEnumerable<OrdinalData>) ordData, null);
                    ...
                    case StatisticType.StandardDeviation:
                        ...
                        keyValues = sDev.PerformStatistic((IEnumerable<OrdinalData>) ordData, null);
                    ...
                    case StatisticType.Variance:
                        ...
                        keyValues = variance.PerformStatistic((IEnumerable<OrdinalData>) ordData, null);
                    ...
                    case StatisticType.CoefficientOfVariance:
                        ...
                        keyValues = coeffVar.PerformStatistic((IEnumerable<OrdinalData>) ordData, null);
                    ...
                    case StatisticType.Percentile:
                        ...
                        keyValues = percentile.PerformStatistic((IEnumerable<OrdinalData>) ordData, 0.5);
                    ...
                    case StatisticType.ProbabilityDistribution:
                        ...
                        keyValues = PrsDev.PerformStatistic((IEnumerable<OrdinalData>) ordData, null);
                        keyValues.TryGetValue("Standard Deviation", out var PrSDr);
                        var Prmean = new MeanStatistic();
                        keyValues = Prmean.PerformStatistic((IEnumerable<OrdinalData>) ordData, null);
                    ...
                    case StatisticType.BinomialDistribution:
                        ...
                        keyValues = binDis.PerformStatistic((IEnumerable<OrdinalData>) ordData, 0.5);
                    ...
                    case StatisticType.LeastSquaresLine:
                        ...
                        keyValues = leastSqr.PerformStatistic((IEnumerable<OrdinalData>) ordData, null);
                    ...
                    case StatisticType.ChiSquare:
                        ...
                        keyValues = chiSqr.PerformStatistic(interData, null);
                    ...
                    case StatisticType.CorrelationCoefficient:
                        ...
                        keyValues = corrCoe.PerformStatistic((IEnumerable<OrdinalData>) ordData, null);
                    ...
                    case StatisticType.SignTest:
                        ...
                        keyValues = sign.PerformStatistic((IEnumerable<OrdinalData>) ordData, null);
                    ...
                    case StatisticType.RankSumTest:
                        ...
                        keyValues = rankSum.PerformStatistic((IEnumerable<OrdinalData>) ordData, null);
                    ...
                    case StatisticType.SpearmanRankCorrelationCoefficient:
                        ...
                        keyValues = spearman.PerformStatistic((IEnumerable<OrdinalData>) ordData, null);
